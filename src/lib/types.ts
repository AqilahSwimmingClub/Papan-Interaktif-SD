...
/**
 * Dunia permainan V2. Setiap kode mempunyai aturan input dan perubahan state;
 * kode ini bukan tema visual atau alias untuk kartu kuis.
 */
export type MekanikGameAnak =
  ...
  | 'timeline_adventure'
  | 'simulation_game'
  | 'resource_management_edu'
  | 'science_mission'
  | 'math_manipulative_game'
  | 'number_adventure'
  | 'word_adventure'
  | 'reading_detective'
  | 'coding_quest'
  ...
  /** Alias konten IPAS lama yang tetap dibaca tanpa migrasi destruktif. */
  | 'racing_game'
  | 'monster_battle'
  | 'fishing_catch'
  | 'platform_jump'
