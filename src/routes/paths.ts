...
export const RUTE = {
  ...
  dasbor: '/dasbor',
  kuisLangsung: '/kelas/kuis-langsung',
  alatMatematika: '/kelas/alat-matematika',
  undianNama: '/kelas/undian-nama',
  timerKelas: '/kelas/timer',
  poinKelompok: '/kelas/poin-kelompok',
  vlab: '/pembelajaran/vlab',
  dualWindow: '/pembelajaran/game/dual-window',
  generateLkpd: '/fitur/generate-lkpd',
  bankSoal: '/fitur/generate-bank-soal',
  kelas: '/kelas',
  ...
  profilGuru: '/pengaturan/profil-guru',
  gantiPassword: '/pengaturan/ganti-password',
  profilSekolah: '/pengaturan/profil-sekolah',
  profilAdmin: '/pengaturan/profil-admin',
  dataGuru: '/pengaturan/data-guru',
  resetPasswordGuru: '/pengaturan/reset-password-guru',
